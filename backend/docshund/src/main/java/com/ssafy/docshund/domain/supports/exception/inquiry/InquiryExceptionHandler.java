...
public class InquiryExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> inquiryException(
		InquiryException exception
	) {
		...
		log.error("InquiryException: code={}, message={}", exceptionCode.getCode(), localizedMessage);
